...
const Secp256k1KeyPair = require('@sphereon/rn-ecdsa-secp256k1-verification-key-2019');
const {JwsLinkedDataSignature} = require('@sphereon/rn-jws-linked-data-signature');
